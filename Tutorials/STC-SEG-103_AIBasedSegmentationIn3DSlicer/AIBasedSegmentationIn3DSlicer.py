...
class Slicer4MinuteTest(ScriptedLoadableModuleTest):
    ...
    def test_Slicer4Minute1(self):
        ...
        # TUTORIALMAKER INFO TITLE MonaiAi
        ...
        modelCombo.setCurrentItem(modelCombo.findItems("Prostate - Multisequence", qt.Qt.MatchExactly)[0])
        ...
        #searchBox = slicer.util.findChild(slicer.util.mainWindow(), "modelSearchBox")
        searchBox.setText("Brain Tumor Segmentation (BRATS) GLI")

        #modelCombo = slicer.util.findChild(slicer.util.mainWindow(), "modelComboBox")
        modelCombo.setCurrentItem(modelCombo.findItems("Brain Tumor Segmentation (BRATS) GLI", qt.Qt.MatchExactly)[0])
        ...
        searchBox.setText("Whole body segmentation TS1 - quick")
        modelCombo.setCurrentItem(modelCombo.findItems("Whole body segmentation TS1 - quick", qt.Qt.MatchExactly)[0])
